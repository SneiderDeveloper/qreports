<template>
    <div class="tw-overflow-x-hidden">
        ...
        <h4 class="text-primary tw-text-base tw-font-extrabold tw-mb-6">Select and sort the columns</h4>
        ...
        ">
             <div v-for="(field, keyField) in formFields.reportsColumns" :key="keyField">
                <dynamic-field class="check-report-1" :field="field"/>
            </div>
        </div>


        <h4 class="text-primary tw-text-base tw-font-extrabold tw-mt-8 tw-mb-6">Select the first 4 filters</h4>
        
        <div class="tw-flex tw-space-x-4">
            <div v-for="(field, keyField) in formFields.reportsFilters" :key="keyField">
                <dynamic-field class="check-report-2" :field="field"/>
            </div>
        </div>
...
.check-report-2 .q-checkbox[aria-checked="mixed"] .q-checkbox__inner--indet .q-checkbox__bg {
   @apply tw-hidden;
}
</style>
